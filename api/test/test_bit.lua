...
---ngx.say(_key_slot("abcd"))

abc = {}
local a = "120.1:12";
local b = "120.2:12";
local redis = ciredis:new({host="10.185.240.132", port="6379", password="foobared"});
redis:set("aa", "55")
abc[a] = redis
ngx.say(abc[a]:get("aa"))